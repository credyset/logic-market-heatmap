...
def agency():
    ...
    return shell('Logic Inc · Agency','Supply-chain and operating intelligence for scaling consumer-product brands.',[('Verified sources','162'),('Founder quotes','238'),('Topic clusters','17'),('Categories','6')],sections,dls,{'ink':'#212121','paper':'#F3F3F3','panel':'#FFFFFF','muted':'#3E3E3E','accent':'#FF600A','accent2':'#E55509','line':'#DFDFDF','hero':'#2A2A2A'})
...
def pac():
    ...
    return shell('Logic Pac','Packaging intelligence across design, materials, manufacturing, retail performance, and capital readiness.',[('Verified sources','162'),('Packaging quotes','99'),('Design themes','6'),('Categories','6')],sections,dls,{'ink':'#050D1F','paper':'#F5F5F3','panel':'#FFFFFF','muted':'#4A5568','accent':'#E0FD2C','accent2':'#0D1F4A','line':'#D8DDE8','hero':'#050D1F'})
