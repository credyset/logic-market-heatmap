...
def agency():
    ...
    return shell('Logic Inc · Agency','Supply-chain and operating intelligence for scaling consumer-product brands.',[('External sources','332'),('Classified chunks','6,854'),('Retained topics','17'),('Evidence excerpts','128')],sections,dls,{'ink':'#212121','paper':'#F3F3F3','panel':'#FFFFFF','muted':'#3E3E3E','accent':'#FF600A','accent2':'#E55509','line':'#DFDFDF','hero':'#2A2A2A'})
